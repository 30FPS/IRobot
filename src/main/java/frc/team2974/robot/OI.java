...
public class OI {
    ...
    //Intake buttons
    public static final JoystickButton leftIntake = new JoystickButton(leftJoystick, LEFT_INTAKE_PORT);
    public static final JoystickButton rightIntake = new JoystickButton(leftJoystick, RIGHT_INTAKE_PORT);
}
